...
class PitchesControllerTest < ActionController::TestCase
  ...
  test "should create pitch" do
    assert_difference('Pitch.count') do
      post :create, pitch: { all: @pitch.all, game_id: @pitch.game_id, player: @pitch.player, take: @pitch.take }
    end
  ...
  test "should update pitch" do
    put :update, id: @pitch, pitch: { all: @pitch.all, game_id: @pitch.game_id, player: @pitch.player, take: @pitch.take }
    assert_redirected_to pitch_path(assigns(:pitch))
  end
